                    ...
                    <?php if(isset($employee_id)): ?>
                        <table class="table table-dark table-style">
                            ...
                            <tbody>
                                <?php foreach($messages as $message): ?>
                                    <tr>
                                        <td><a href="user_case_details.php?<?php if(isset($case_id)){echo "case_id=".$case_id."&";} ?>message_id=<?php echo $message["message_id"]; ?>"><?php foreach($employees as $employee): ?><?php if($employee["employee_id"] == $message["sender"]): ?><?php echo $employee["firstname"]." ".$employee["lastname"]; ?><?php endif; ?><?php endforeach; ?></a></td>
